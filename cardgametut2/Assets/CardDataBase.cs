...
public class CardDataBase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        cardList.Add(new Card(2, "Dwarf", 3, 3000, "Add 1 max Mana", Resources.Load<Sprite>("1"), "Red", 0, 1));
        cardList.Add(new Card(3, "Human", 5, 6000, "Add 3 max Mana", Resources.Load<Sprite>("1"), "Blue", 0, 3));
