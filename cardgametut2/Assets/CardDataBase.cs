...
public class CardDataBase : MonoBehaviour
{
    ...
    void Awake()
    {
        cardList.Add(new Card(0, "None", 0, 0, 0, Resources.Load<Sprite>("1"), "None", new CardAbillity[]{ new CADraw(0, "Draw 0 Cards") }));
        cardList.Add(new Card(1, "Elf", 2, 1, 1, Resources.Load<Sprite>("1"), "Green", new CardAbillity[] { new CADraw(2, "Draw 2 Cards") }));
        cardList.Add(new Card(2, "Dwarf", 3, 3, 3, Resources.Load<Sprite>("1"), "Red", new CardAbillity[] { new CAAddMana(1, "Add 1 max Mana") }));
        cardList.Add(new Card(3, "Human", 5, 6, 5, Resources.Load<Sprite>("1"), "Blue", new CardAbillity[] { new CAAddMana(3, "Add 3 max Mana") }));
